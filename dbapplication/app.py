#db object will be required in models.py
#creating a circular import in both app.py and models.py files
#importing models in app and app in models creating a circular import
